...
#if defined(CONFIG_LU6500)
SOC_DOUBLE_R("AIF1ADC1 VU Switch",
             WM8994_AIF1_ADC1_LEFT_VOLUME, WM8994_AIF1_ADC1_RIGHT_VOLUME,
             8, 1, 0),
#endif
...
SOC_DOUBLE_R_TLV("AIF1DAC1 Volume", WM8994_AIF1_DAC1_LEFT_VOLUME,
		 WM8994_AIF1_DAC1_RIGHT_VOLUME, 1, 104, 0, digital_tlv),
...
#if defined (CONFIG_SU880) || defined (CONFIG_KU8800) || defined (CONFIG_MACH_STAR)  || defined (CONFIG_MACH_BSSQ)//                                                                                 
...
//                                                          
#if defined(CONFIG_MACH_BSSQ)
#define	TEGRA_HEADSET_DET 32
	disable_irq(gpio_to_irq(TEGRA_HEADSET_DET));
	int tmp = disable_irq_wake(gpio_to_irq(TEGRA_HEADSET_DET));
	printk(KERN_ERR "Test Disable Headset Det GPIO[%d]\n", tmp);
#undef	TEGRA_HEADSET_DET
#endif
//                                                          
...
#if defined(CONFIG_MACH_BSSQ)
#define	TEGRA_HEADSET_DET 32
	enable_irq(gpio_to_irq(TEGRA_HEADSET_DET));
	int tmp = enable_irq_wake(gpio_to_irq(TEGRA_HEADSET_DET));
	printk(KERN_ERR "Test Enable Headset Det GPIO[%d]\n", tmp);
#undef	TEGRA_HEADSET_DET
#endif
//                                                          
