...
//                                                                     
#if defined (CONFIG_KS1103) || defined(CONFIG_LU6500) || defined(CONFIG_SU880)|| defined(CONFIG_KU8800) || defined(CONFIG_MACH_STAR_SU660)//                             
...
//                                                                    
#if defined(CONFIG_MACH_STAR_SU660) || defined(CONFIG_SU880)|| defined(CONFIG_KU8800)
...
#if defined (CONFIG_LU6500) || (CONFIG_KS1001)	
	input_event(input, EV_SW, SW_LID, 1); //                                                      
	input_sync(input);
#endif
	for (i = 0; i < pdata->nbuttons; i++)
