...
static struct dvfs dvfs_init[] = {
	...
	CPU_DVFS("cpu", 2, 0, MHZ,   0,   0,   0,   0, 655, 760,  798,  798,  950,  970,  1015,  1040,  1100, 1178, 1200),
	CPU_DVFS("cpu", 2, 1, MHZ,   0,   0,   0,   0, 655, 760,  798,  798,  950,  970,  1015,  1040,  1100, 1200),
	CPU_DVFS("cpu", 2, 2, MHZ,   0,   0,   0,   0, 769, 845,  902,  902,  1026, 1092, 1140,  1197,  1200),
	CPU_DVFS("cpu", 2, 3, MHZ,   0,   0,   0,   0, 940, 1000, 1045, 1045, 1130, 1160, 1200),
