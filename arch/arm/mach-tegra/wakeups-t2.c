...
//                                                                    
	...
	[32] = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PE0), // WAR for HP DET LP1 wake
	[33] = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PG0), // LP1 wake : Volume Key Up
	[34] = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PG1), // LP1 wake : Volume Key Down
#else
