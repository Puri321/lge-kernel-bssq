...
const struct tegra_init_gpio_info tegra_sleep_gpio_info_array[] = {
    ...
    { 'u'-'a',      2, GPIO_ENABLE, GPIO_OUTPUT,    GPIO_SLEEP_HIGH,  GPU},   // MDM_UART_SW
    { 'u'-'a',      4, GPIO_ENABLE, GPIO_OUTPUT,    GPIO_SLEEP_LOW,   GPU},   // VIBE_EN
...
#endif
	{ 'q'-'a',		5,	GPIO_ENABLE,	GPIO_INPUT,		GPIO_SLEEP_HIGH,	KBCF},  // GYRO_INT_N
	...
	{ 'i'-'a',		0,	GPIO_ENABLE,	GPIO_INPUT,		GPIO_SLEEP_HIGH,	ATC},  // MOTION_INT
    { 'x'-'a',      5, GPIO_ENABLE, GPIO_INPUT,     GPIO_SLEEP_LOW,   SPIE},  // TOUCH_MAKER_ID
	{ 'x'-'a',		6,	GPIO_ENABLE,	GPIO_INPUT,		GPIO_SLEEP_HIGH,	SPIE},  // TOUCH_INT
	...
	{ 'j'-'a',		6,	GPIO_ENABLE,	GPIO_INPUT,		GPIO_SLEEP_HIGH,	IRRX},  // LOWER_TOUCH_INT/ (SU660)
#else
